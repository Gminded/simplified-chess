...
class ChessAI:
    ...
    def GetMove(self, currentNode):
        ...
        try:
            ...
            while True:
                #htime = 0
                bestMove = self.AlphaBetaInit(currentNode=currentNode, depth=depth)#, htime=htime)
    ...
    def AlphaBetaInit(self, alpha=-10000, beta=10000, currentNode=None, maxPlayer=True, depth=0):
        v = -10000
        counter = 0
        inner = 1
        moves = []
